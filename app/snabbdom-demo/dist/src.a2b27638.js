...
var patch = (0, _snabbdom.init)([_style.styleModule, _eventlisteners.eventListenersModule, _class.classModule, _props.propsModule]);
var sortBy = 'rank';
var vnode;
var nextKey = 11;
var margin = 8;
...
var data = [originalData[0], originalData[1], originalData[2], originalData[3], originalData[4], originalData[5], originalData[6], originalData[7], originalData[8], originalData[9]]; // 渲染DOM
